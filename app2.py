...
if __name__ == "__main__":
    ...
    # Azure envs (make sure all are set)
    ...
    print(f"\n--- Actionable Insight for {specific_user} ---")
    print(query_rag_chain(vector_store, azure_chat_args, specific_q))
# Azure OpenAI API Keys and Deployments

# The deployment name for your Azure OpenAI embeddings model
AZURE_OPENAI_EMBEDDING_DEPLOYMENT=your-embedding-deployment-name

# The deployment name for your Azure OpenAI chat/completion model
AZURE_OPENAI_CHAT_DEPLOYMENT=your-chat-deployment-name

# Your Azure OpenAI resource endpoint (should start with https://)
